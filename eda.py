...
def run_eda():
    ...
    button = st.button('데이터에 대한 설명보기!', key=button_key)
...
Star type : 별 유형\n 
    ...
    3 => 주계열(Main Sequence) : 주계열 별은 수소 원소를 헬륨으로 핵융합하는 과정에서 에너지를 생성하는 별의 주요 단계입니다.
